...
/**
 * Interface that defines the functionality to convert a SyndFeed
...
public interface Converter {
     ...
     * @param syndFeed the SyndFeed that will contain the copied/converted values of the real feed.
     *
     */
     ...
     * <p>
     * @param syndFeed SyndFeed to copy/convert value from.
     * @return a real feed with copied/converted values of the SyndFeed.
     *
     */
